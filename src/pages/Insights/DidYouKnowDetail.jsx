...
export default function DidYouKnowDetail() {
  ...
  if (!item) {
    return (
      <div data-page="Insight_Context_Page" aria-label="Did You Know Detail Page" className="py-16 text-center">
  ...
  return (
    <div data-page="Insight_Context_Page" aria-label="Did You Know Detail Page" className="space-y-4">
      <button
        type="button"
